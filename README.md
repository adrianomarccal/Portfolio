...
| :--- | :--- | :---: |
| **Experiência 01: A Corrida do Prompt** | Fundamentos e estruturação de comandos precisos para IA. | [Ver Projeto](./experiencia-01/) |
| **Experiência 02: Laboratório de Classificação Visual** | Utilização de IA para reconhecimento e classificação de imagens. | [Ver Projeto](./experiencia-02/) |
| **Experiência 03: Batalha de Modelos & Eng. de Prompt** | Comparativo prático de LLMs com uso de estruturação em XML. | [Ver Projeto](./experiencia-03/) |

#### 🚀 Engenharia de Software & Produto
| Projeto | Descrição | Link |
| :--- | :--- | :---: |
| **Experiência 04: Engenharia Reversa** | Análise de sistemas e desconstrução de fluxos lógicos e processos. | [Ver Projeto](./experiencia-04/) |
| **Experiência 05: Do Clone ao MVP+** | Desenvolvimento de um Produto Mínimo Viável focado em validação de ideias. | [Ver Projeto](./experiencia-05/) |
| **Experiência 06: Eng. de Software e IA com Bubble.io** | Criação de aplicação web No-Code integrada com inteligência artificial. | [Ver Projeto](./experiencia-06/) |
